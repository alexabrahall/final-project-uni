...
model_args = ClassificationArgs(num_train_epochs=3, use_multiprocessing=False, process_count=2, use_multiprocessing_for_evaluation=False, best_model_dir="outputs/fbert", overwrite_output_dir=True, save_best_model=True, wandb_project="Final Project",wandb_kwargs={"name": "fBERT"})
